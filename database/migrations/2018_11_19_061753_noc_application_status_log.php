...
class NocApplicationStatusLog extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('noc_application_status_log', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('noc_application_status_log');
    }
}
