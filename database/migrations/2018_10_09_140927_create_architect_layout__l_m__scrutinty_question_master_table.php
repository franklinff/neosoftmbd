...
class CreateArchitectLayoutLMScrutintyQuestionMasterTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('architect_layout_lm_scrunity_question_master', function (Blueprint $table) {
            $table->increments('id');
