...
class CreateSfApplicationStatusLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sf_application_status_logs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('sf_application_status_logs');
    }
}
