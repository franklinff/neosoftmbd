    ...
    <div class="m-subheader px-0 m-subheader--top">
        ...
        <div class="m-portlet m-portlet--compact filter-wrap">
            <div class="row align-items-center row--filter">
                <div class="col-md-12">
                    <form role="form" id="eeForm" method="get" action="{{ route('em.consent_for_oc') }}">
                            ...
                            <div class="col">
                                <div class="form-group m-form__group">
                                    <div class="btn-list">
                                        ...
                                        <button type="reset" onclick="window.location.href='{{ url("/consentoc_em") }}'" class="btn m-btn--pill m-btn--custom btn-metal">Reset</button>
                                    </div>
                                </div>
                            </div>
                        </div>
