...
<li id="dyco-actions" class="collapse show">
    <ul class="list-unstyled">
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='formation.view_application')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='formation.society_documents')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='formation.em_srutiny_and_remark')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='formation.forward_application')?'m-menu__item--active':''}}">
