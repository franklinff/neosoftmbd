            ...
            <div class="m-portlet__body m-portlet__body--spaced">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-sm-4 offset-sm-1 form-group">
                        <div class="@if($errors->has('department')) has-error @endif">
                            ...
                            <select name="department" id="department_id" class="form-control m-bootstrap-select m_selectpicker form-control--custom m-input" disabled>
                    ...
                    <div class="col-sm-4 offset-sm-1 form-group">
                        <div class="@if($errors->has('resolution_code')) has-error @endif">
                            ...
                            <input type="text" name="resolution_code" id="resolution_code" class="form-control form-control--custom m-input"
                                value="{{old('resolution_code',$resolution->resolution_code)}}" readonly disabled>
                ...
                <div class="form-group m-form__group row">
                    <div class="col-sm-4 form-group">
                        <div class="@if($errors->has('title')) has-error @endif">
                            ...
                            <input type="text" name="title" id="title" class="form-control form-control--custom m-input"
                                value="{{old('title',$resolution->title)}}" readonly disabled>
                    ...
                    <div class="col-sm-4 offset-sm-1 form-group">
                        <div class="@if($errors->has('revision_log_message')) has-error @endif">
                            ...
                            <textarea name="keyword" id="keyword" class="form-control form-control--custom form-control--fixed-height m-input" readonly disabled>{{old('keyword',$resolution->keyword)}}</textarea>
                ...
                <div class="form-group m-form__group row">
                    <div class="col-sm-4 form-group">
                        <div class="@if($errors->has('description')) has-error @endif">
                            ...
                            <textarea name="description" id="description" class="form-control form-control--custom form-control--fixed-height m-input" readonly disabled>{{old('description',$resolution->description)}}</textarea>
                ...
                <div class="form-group m-form__group row">
                    <div class="col-sm-4 form-group">
                        <div class="@if($errors->has('language')) has-error @endif">
                            ...
                            <input type="text" name="language" id="language" class="form-control form-control--custom m-input"
                                value="{{old('language',$resolution->language)}}" readonly disabled>
                    ...
                    <div class="col-sm-4 offset-sm-1 form-group">
                        <div class="@if($errors->has('reference_link')) has-error @endif">
                            ...
                            <input type="text" name="reference_link" id="reference_link" disabled class="form-control form-control--custom m-input"
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-sm-4 offset-sm-1 form-group">
                        ...
                        <div class="@if($errors->has('revision_log_message')) has-error @endif">
                            <textarea name="revision_log_message" id="revision_log_message" disabled class="form-control form-control--custom form-control--fixed-height m-input" readonly>{{old('revision_log_message',$resolution->revision_log_message)}}</textarea>
