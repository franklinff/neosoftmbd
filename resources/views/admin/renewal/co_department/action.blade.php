...
<!--         <li class="m-menu__item m-menu__item--submenu m-menu__item--level-3 {{($route=='renewal.prepare_renewal_agreement')?'m-menu__item--active':''}}">
    ...
    @if($data->stamp_by_dycdo == '0' && ($data->application_status == config('commanConfig.renewal_status.Draft_Renewal_of_Lease_deed') || $data->application_status == config('commanConfig.renewal_status.Approved_Renewal_of_Lease') || $data->application_status == config('commanConfig.renewal_status.Stamp_Renewal_of_Lease_deed') ))
