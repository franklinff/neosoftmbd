...
<div class="col-md-12">
    <div class="m-subheader px-0 m-subheader--top">
        <div class="d-flex align-items-center">
            <h3 class="m-subheader__title m-subheader__title--separator">Reports - Department</h3>
        ...
        <div class="m-portlet m-portlet--compact filter-wrap">
            <div class="row align-items-center row--filter">
                <div class="col-md-12">
                    <form class="form-group m-form__group row align-items-center mb-0" method="get" action="{{ route('rti_reports_department') }}">
                        <div class="col-md-2">
                        ...
                        <div class="col">
                            <div class="form-group m-form__group">
                                <div class="btn-list">
                                    ...
                                    <a href="{{route('rti_reports_department')}}" class="btn m-btn--pill m-btn--custom btn-metal">Reset</a>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <div class="m-portlet m-portlet--compact m-portlet--mobile">
            <div class="m-portlet__body">
               ...
               <table class="table">
                   ...
                   @foreach ($data['report_departments'] as $data)
                   <tr>
