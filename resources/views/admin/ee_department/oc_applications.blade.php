...
<div class="col-md-12">
    ...
    <div class="m-subheader px-0 m-subheader--top">
        <div class="d-flex align-items-center" id="search_box">
            <h3 class="m-subheader__title m-subheader__title--separator">Applications for Consent for OC</h3>
            {{ Breadcrumbs::render('ee_for_oc') }}
        ...
        <div class="m-portlet m-portlet--compact filter-wrap">
            <div class="row align-items-center row--filter">
                <div class="col-md-12">
                    <form role="form" id="eeForm" method="get" action="{{ route('ee.consent_for_oc') }}">
                            ...
                            <div class="col">
                                <div class="form-group m-form__group">
                                    <div class="btn-list">
                                        ...
                                        <button type="reset" onclick="window.location.href='{{ url("/consentoc_ee") }}'" class="btn m-btn--pill m-btn--custom btn-metal">Reset</button>
                                    </div>
                                </div>
                            </div>
                        </div>
