...
<li id="tripartite-actions" class="collapse show">
    <ul class="list-unstyled">
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='tripartite.view_application')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='tripartite.view_society_documents')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='tripartite.tripartite_agreement')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='tripartite.ree_note')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='tripartite.forward_application')?'m-menu__item--active':''}}">
