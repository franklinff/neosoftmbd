                ...
                <div class="table-responsive">
                    <table class="table text-center">
                        ...
                        <tr>
                            ...
                            <td><span class="count-circle">{{$architect_data['layouts_pending_at_sap']}}</span></td>
                            {{--<td><button class="btn btn-action">View</button></td>--}}
                        </tr>
                        <tr>
                            <td class="text-center">3.</td>
                            <td>Application Forwarded to CAP</td>
                            <td><span class="count-circle">{{$architect_data['sap_forwarded_layouts']}}</span></td>
                            {{--<td><button class="btn btn-action">View</button></td>--}}
                        </tr>
                        <tr>
                            <td class="text-center">4.</td>
                            <td>Application sent back to CO</td>
                            <td class="text-center"><span class="count-circle">{{$architect_data['sap_reverted_layouts']}}</span></td>
                            {{--<td><button class="btn btn-action">View</button></td>--}}
                        </tr>
                        </tbody>
                    </table>
