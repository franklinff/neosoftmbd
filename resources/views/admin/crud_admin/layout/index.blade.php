    ...
    <div class="col-md-12">
        ...
        <div class="m-subheader px-0 m-subheader--top">
            <div class="d-flex align-items-center">
                ...
                {{ Breadcrumbs::render('layout_detail') }}
                {{--<div class="btn-list text-right ml-auto">--}}
                    {{--<a href="{{route('layouts.index',['excel'=>'excel'])}}" name="excel" value="excel" class="btn excel-icon"><img src="{{asset('/img/excel-icon.svg')}}"></a>--}}
...
<script>
    ...
    //function to detele layout details
    $(document).ready(function () {
        $(document).on("click", ".delete-layout", function () {
            ...
            $.ajax({
                ...
                url:"{{ route('loadDeleteLayoutUsingAjax') }}",
