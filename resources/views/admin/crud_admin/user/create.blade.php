...
@section('content')
    <div class="col-md-12">
        ...
        <div class="m-portlet m-portlet--mobile">
            <form id="adduser" role="form" method="post" class="m-form m-form--rows m-form--label-align-right" action="{{route('users.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="m-portlet__body m-portlet__body--spaced">
                    ...
                    <div class="form-group m-form__group row">
                        <div class="col-sm-4 form-group">
                            ...
                            <div class="m-input-icon m-input-icon--right">
                                <input type="text" id="mobile_no" name="mobile_no" class="form-control form-control--custom m-input"  value="{{ old('mobile_no') }}">
                        ...
                        <div class="col-sm-4 offset-sm-1 form-group">
                            ...
                            <div class="m-input-icon m-input-icon--right">
                                <input type="text" id="address" name="address" class="form-control form-control--custom m-input"  value="{{ old('address') }}">
                    ...
                    <div class="form-group m-form__group row">
                        <div class="col-sm-4 form-group">
                            ...
                            <div class="m-input-icon m-input-icon--right">
                                <input type="text" id="password" name="password" class="form-control form-control--custom m-input"  value="{{ old('password') }}">
                    ...
                    <div class="form-group m-form__group row">
                        <div class="col-sm-4 form-group">
                            ...
                            <div class="m-input-icon m-input-icon--right">
                                <input type="text" id="service_start_date" name="service_start_date" class="form-control form-control--custom m-input m_datepicker"  value="{{ old('service_start_date') }}">
                        ...
                        <div class="col-sm-4 offset-sm-1 form-group">
                            ...
                            <div class="m-input-icon m-input-icon--right">
                                <input type="text" id="service_end_date" name="service_end_date" class="form-control form-control--custom m-input m_datepicker"  value="{{ old('service_end_date') }}">
