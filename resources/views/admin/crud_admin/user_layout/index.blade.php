    ...
    <div class="col-md-12">
        ...
        <div class="m-subheader px-0 m-subheader--top">
            <div class="d-flex align-items-center">
                <h3 class="m-subheader__title m-subheader__title--separator">Layout Detail</h3>
                {{ Breadcrumbs::render('user_layout_detail') }}
                {{--<div class="btn-list text-right ml-auto">--}}
                    {{--<a href="{{route('user_layouts.index',['excel'=>'excel'])}}" name="excel" value="excel" class="btn excel-icon"><img src="{{asset('/img/excel-icon.svg')}}"></a>--}}
...
<script>
    ...
    //function to detele user_layout details
    $(document).ready(function () {
        $(document).on("click", ".delete-user-layout", function () {
            ...
            $.ajax({
                ...
                url:"{{ route('loadDeleteUserLayoutUsingAjax') }}",
