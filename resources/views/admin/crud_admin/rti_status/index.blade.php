    ...
    <div class="col-md-12">
        ...
        <div class="m-subheader px-0 m-subheader--top">
            <div class="d-flex align-items-center">
                <h3 class="m-subheader__title m-subheader__title--separator">RTI Status Detail</h3>
                {{ Breadcrumbs::render('rti_status_detail') }}
...
<script>
    ...
    $(document).ready(function () {
        $(document).on("click", ".delete-rti-status", function () {
            ...
            $.ajax({
                ...
                url:"{{ route('DeleteRTIStatusUsingAjax') }}",
